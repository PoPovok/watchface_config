...
class ComplicationSelectorScreenSecond extends StatelessWidget {
  final Map<String, List<ComplicationType>> supportedTypeList = {
    "Right": acceptableComplicationTypesByExample.toList(),
  ...
  ComplicationSelectorScreenSecond({super.key});
                      ...
                      child: WatchFaceInfoProvider(builder: (context, watchfaceInfo) {
                        return Column(children: [
                          ...
                          ...complications.mapIndexed((index, complication) =>
                              ComplicationButton(complication: complication, title: supportedTypeList.keys.toList()[index])),
                        ]);
                      })),
                ))));
  }
