package hu.popoapps.watchface_config_example_complex.watchface.ancestors
...
import hu.popoapps.watchface_config_example_complex.watchface.model.Bounds
...
abstract class CustomWatchfaceComplication : CustomWatchface() {
    ...
    abstract inner class EngineComplication : Engine() {
        ...
        protected fun complicationSurfaceChanged(
            ...
            val complicationBounds = Bounds(width).run {
                arrayOf(leftBounds, topBounds, rightBounds, bottomBounds)
            }
