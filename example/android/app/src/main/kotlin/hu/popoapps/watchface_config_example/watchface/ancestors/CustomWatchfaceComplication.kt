...
import hu.popoapps.watchface_config_example.watchface.model.Bounds
import hu.popoapps.watchface_config_example.watchface.model.ComplicationDataProvider
import hu.popoapps.watchface_config_example.watchface.model.DefaultBounds
        ...
        protected fun complicationSurfaceChanged(
            ...
            complications.zip(complicationBounds).forEach {
                it.first.complicationDrawable.apply {
                    bounds = it.second
                    setRangedValuePrimaryColorActive(Color.BLUE)
